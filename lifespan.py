...
def age(birthday, expected_lifespan=80):
    ...
    print(f"You've lived {(days_alive / days_left) * 100}% of your life. Remember that it's never too late to do anything until you're already dead! Make the most of the rest, and keep growing!!")
